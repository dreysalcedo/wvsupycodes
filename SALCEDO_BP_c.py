# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 16:51:38 2020
...
# Create plot
plt.title("Learning Curve Backpropgation (4-2-2-3 Network)")
...
Iris_setosa["PetalWidthCm"].plot.hist(alpha=0.5,color='blue',bins=50) # Setting the opacity(alpha value) & setting the bar width((bins value)
Iris_versicolor["PetalWidthCm"].plot.hist(alpha=0.5,color='green',bins=50)
Iris_virginica["PetalWidthCm"].plot.hist(alpha=0.5,color='red',bins=50)
plt.legend(['Iris-setosa','Iris_versicolor','Iris-virginica'])
plt.xlabel('PetalWidthCm')
plt.ylabel('Frequency')
plt.title('PetalWidthCm on Species (Using 4-2-2-3 Network)')
plt.show()

#==========================
print("===============================================")
print("Time and Performance Statistics: ")
print("\nPredicted Petal Width (Using 4-1-3 Network): ")
print(data.sort_values(by='PetalWidthCm'))

print("\nTime to execute: %0.5f seconds" % (time.time() - start_time))
